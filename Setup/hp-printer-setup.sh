...
echo "ℹ️ Instalando paquetes de impresión (CUPS, HPLIP, HPLIP-GUI, system-config-printer)..."
sudo apt update
sudo apt install -y \
    cups \
    cups-client \
...
echo "   2) Puedes administrar impresoras desde GNOME en 'Configuración -> Impresoras'."
