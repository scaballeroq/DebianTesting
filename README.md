...
- **`gnome-extensions.sh`**: Instalación automatizada y limpia de 11 extensiones de GNOME Shell con compilación de esquemas (ver [Guía de Extensiones GNOME](./Docs/gnome_extensions_es.md)).
...
just extensions          # Instala y compila las 11 extensiones de GNOME
