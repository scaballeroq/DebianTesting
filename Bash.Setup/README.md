# 🚀 Bash.Setup (DebianTesting)

Colección de scripts de configuración y funciones avanzadas para potenciar tu terminal Bash en Linux (optimizado para Debian Testing con GNOME).
